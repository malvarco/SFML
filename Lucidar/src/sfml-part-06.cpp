...
// Example 3 : shaked
// Example 4 : fade
//#define SHADER_FILENAME         "./frag/06/example_001.frag"
//#define SHADER_FILENAME         "./frag/06/example_002.frag"
//#define SHADER_FILENAME         "./frag/06/example_003.frag"
//#define SHADER_FILENAME         "./frag/06/example_004.frag"
#define SHADER_FILENAME         "./frag/06/example_005.frag"
...
int wWinMain()
{
    ...
    sprite.setOrigin((float)spriteSize.width / 2., (float)spriteSize.height / 2.);
